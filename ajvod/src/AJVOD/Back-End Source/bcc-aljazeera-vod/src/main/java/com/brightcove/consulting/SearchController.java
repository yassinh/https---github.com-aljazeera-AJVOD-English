...
public class SearchController extends YBTVBaseController {
    ...
    public String search(Locale locale, Model model, HttpServletRequest pRequest, HttpServletResponse pResponse
        ...
        model.addAttribute("livePlayerId", channel.getConfig("livePlayerId") );
        model.addAttribute("livePlayerKey", channel.getConfig("livePlayerKey") );
        model.addAttribute("viralPlayerId", channel.getConfig("viralPlayerId") );
        model.addAttribute("viralPlayerKey", channel.getConfig("viralPlayerKey") );
    ...
    Map searchAhead(
        ...
        BrightcoveResponse<BrightcoveVideo> videos = retrieveSearchedVideos(searchTerm, channelId, 0, 2, new Sort(Direction.DESC, SortProperty.PLAYS_TRAILING_WEEK), null);
