...
public class UtilityController extends YBTVBaseController {
	...
	public String home(Locale locale, Model model) {
		...
		BrightcoveVideoRequest bvr = new BrightcoveVideoRequest(0, pageSize, new Sort(Direction.NATURAL, SortProperty.MODIFIED_DATE),  videoId);
		...
		BrightcoveVideoRequest bvr2 = new BrightcoveVideoRequest(0, pageSize, new Sort(Direction.NATURAL, SortProperty.MODIFIED_DATE),  playlistId);
