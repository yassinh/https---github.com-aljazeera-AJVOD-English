...
public abstract class YBTVBaseController {
    ...
    */
    ...
    protected SortProperty getSortProperty(String sortKey) {
        if (sortKey == null) {
            return SortProperty.CREATION_DATE;
        }
        try {
	...
	{
		BrightcoveResponse<BrightcoveVideo> videoCollection = readApiService().findVideoById(new BrightcoveVideoRequest(0, pageSize, new Sort(Direction.NATURAL, SortProperty.CREATION_DATE),  videoId));
