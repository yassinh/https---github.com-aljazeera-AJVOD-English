...
public class FindPlaylistsByPlayerId extends PlaylistApi<BrightcovePlaylist, PlaylistPageRequest> {
     ...
     * 
     */
    public FindPlaylistsByPlayerId(String readToken) {
     ...
     *
     */
    public FindPlaylistsByPlayerId(String readToken, Logger apiLogger) {
